...
## 2d detection (opencv)
the script first downloads an image of a pet cat from the web n uses a standard opencv haar cascade (`haarcascade_frontalcatface`) to detect the cat. it draws a simple 2d rectangle `(x, y, w, h)` around it.
